      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="https://i.postimg.cc/C11kqwt9/avatar.jpg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Dayang Nur Nazihah binti M Roslan. A dedicated Computer Science 
            student at UTM Kuala Lumpur, where I'm currently maintaining a 3.97 CGPA. 
            My passion lies in programming and development, with skills in languages like C++, Python, and JavaScript.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; I've had the opportunity to lead several projects, including web and mobile applications, 
             which deepened my knowledge in system design and project management. I have a strong interest in computer hardware 
             and software development, and I enjoy breaking down complex topics to make them easier for others to understand. 
             I also gained valuable communication skills working part-time at Baskin Robbins, where I interacted with customers 
             from diverse backgrounds. I'm always eager to learn and grow in my field. Fluent in multiple languages, I am dedicated 
             to continuous learning and enjoy teaching complex topics in a simple and understandable way.
